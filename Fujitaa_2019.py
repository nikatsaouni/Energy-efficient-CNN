...
x = Conv1D(filters=11, kernel_size=19,activation='relu', padding="valid", name='Conv_1')(input_layer)
x = BatchNormalization()(x)
x = MaxPooling1D(pool_size=2, name='Pooling_1')(x)
x = Conv1D(filters=12, kernel_size=19, padding="valid",activation='relu', name='Conv_2')(x)
x = MaxPooling1D(pool_size=2 , name='Pooling_2')(x)
x = Conv1D(filters=11, kernel_size=11, padding="valid",activation='relu', name='Conv_3')(x)
...
model.save_weights('Fujitaa.h5')
print('Weights saved to Fujitaa.h5 file')
